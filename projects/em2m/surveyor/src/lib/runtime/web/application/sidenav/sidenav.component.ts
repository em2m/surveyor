import {Component, OnInit, Input, ComponentFactoryResolver, Type, ViewContainerRef, ViewChild, OnDestroy} from '@angular/core';
...
export class ApplicationSidenavComponent implements OnInit, OnDestroy {
  ...
  @Input() position ? = 'left';
  @ViewChild('sidenavTop', {read: ViewContainerRef, static: true}) sidenavTop: any;
  @ViewChild('sidenavMiddle', {read: ViewContainerRef, static: true}) sidenavMiddle: any;
  @ViewChild('sidenavBottom', {read: ViewContainerRef, static: true}) sidenavBottom: any;
